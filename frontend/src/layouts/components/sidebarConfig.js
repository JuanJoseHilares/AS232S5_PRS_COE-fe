export const sidebarConfig = [
  ...
  },
  {
    ...
    children: [
      ...
      { key: "suscripciones", label: "Suscripciones", path: "/admin/suscripciones", icon: "credit-card", implemented: true },
      { key: "facturacion", label: "Facturación", path: "/admin/facturacion", icon: "receipt", implemented: true },
      { key: "onboarding", label: "Onboarding", path: "/admin/onboarding", icon: "user-plus", implemented: true }
    ]
  },
  {
    key: "assets",

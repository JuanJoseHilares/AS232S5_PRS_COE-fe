                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {action === 'complete' && (
                            <>
                                ...
                                <div>
                                    <label className="block text-xs font-bold text-gray-500 uppercase tracking-wide mb-2 ml-1">
                                        URL de Imagen del Recibo/Voucher <span className="text-red-500">*</span>
                                    </label>
                                    <input
                                        type="url"
                                        ...
                                        onChange={handleChange}
                                        required
                                        className={`w-full px-4 py-3 bg-gray-50 border-none rounded-xl text-slate-900 placeholder-gray-400 focus:ring-2 ${colorClasses.ring} transition-all`}
                                        placeholder="https://example.com/images/recibo_final.jpg"
                                    />
                                    <p className="text-xs text-slate-400 mt-2 ml-1 font-medium">
                                        📎 Solo imágenes: .jpg, .jpeg, .png, .webp
                                    </p>

                                    {/* Vista previa de la imagen del recibo */}
                                    {formData.receiptImageUrl && (
                                        <div className="mt-4 animate-fadeInScale">
                                            <p className="text-xs font-bold text-gray-500 uppercase tracking-wide mb-2 ml-1">Vista previa</p>
                                            <div className="relative rounded-2xl overflow-hidden border border-gray-100 bg-gray-50 shadow-sm aspect-video">
                                                <img
                                                ...
                                                />
                                                <div className="hidden absolute inset-0 items-center justify-center bg-gray-50 flex-col p-4 text-center">
                                                    <div className="w-12 h-12 bg-gray-100 rounded-full flex items-center justify-center mb-3 text-gray-400">
                                                        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
                                                        </svg>
                                                    </div>
                                                    <p className="text-sm font-semibold text-gray-500">No se pudo cargar la imagen</p>
                                                    <p className="text-xs text-gray-400 mt-1">Verifica que la URL sea correcta y accesible</p>
                                                </div>
                                            </div>
                                        </div>
                                    )}

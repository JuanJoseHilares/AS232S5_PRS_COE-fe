              ...
              {paginatedPersons.length === 0 ? (
                ...
                paginatedPersons.map((person) => {
                  ...
                  return (
                    <tr
                      key={person.id}
                      className="group hover:bg-slate-50 transition-all duration-200 border-l-4 border-l-indigo-500 hover:border-l-indigo-600 bg-white"
                    >
                      <td className="px-6 py-4">
                        <div className="flex items-center gap-3">
                          <div className={`w-3 h-3 rounded-full ${personStatus === "ACTIVE" ? "bg-green-500" : "bg-slate-400"
                            }`}></div>
                          <div>
                            <p className="font-semibold text-slate-900">
                              {person.firstName} {person.lastName}
                            </p>
                            <p className="text-xs text-slate-500">{personStatus === "ACTIVE" ? "Activo" : "Inactivo"}</p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div>
                          <p className="text-sm font-medium text-slate-900">{person.documentNumber}</p>
                          <p className="text-xs text-slate-500">{documentTypes[person.documentTypeId] || "N/A"}</p>
                        </div>
                      </td>

                      <td className="px-6 py-4">
                        <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium ${person.gender === "M" ? "bg-blue-100 text-blue-800" : "bg-pink-100 text-pink-800"
                          }`}>
                      ...
                      <td className="px-6 py-4">
                        <p className="text-sm text-slate-600">{person.personalEmail || "-"}</p>
                      </td>

                      <td className="px-6 py-4">
                        <p className="text-sm text-slate-600">{person.phoneNumber || "-"}</p>
                      </td>
                      ...
                      <td className="px-6 py-4">
                        <div className="flex items-center justify-center gap-1">
                          ...
                          <button
                            ...
                            className={`p-2 rounded-lg transition-all duration-200 ${personStatus !== "ACTIVE"

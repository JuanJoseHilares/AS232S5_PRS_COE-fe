      ...
      <div className="bg-white rounded-2xl shadow-2xl max-w-5xl w-full border border-slate-200">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span
                    className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-md text-xs font-semibold ${statusInfo.bg} ${statusInfo.text} border ${statusInfo.border}`}
                  >
        ...
        <div className="p-5 bg-slate-50 rounded-b-2xl">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            {/* Card: Información Organizacional */}
